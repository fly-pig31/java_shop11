...
public class UserController {
    ...
    public APIResponse userRegister(User user) throws IOException {
        if (ObjectUtils.allNotNull(user.getUsername(), user.getPassword(), user.getRePassword())) {
            // 查重
    ...
    public String saveAvatar(User user) throws IOException {
        ...
        if (file != null && !file.isEmpty()) {
            ...
            String filePath = System.getProperty("user.dir") + uploadPath + File.separator + "avatar" + File.separator + newFileName;
        ...
        if (ObjectUtils.isNotEmpty(newFileName)) {
